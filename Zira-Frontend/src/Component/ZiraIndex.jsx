...
function ToastNotification() {
  ...
  return (
    <div
      className={`z13-toast ${entering ? "z13-toast--entering" : "z13-toast--visible"}`}
    >
      ...
      <button className="z13-toast-close" onClick={() => setVisible(false)}>
        ×
      </button>
    </div>
  );
    ...
    <header className={`z13-header ${scrolled ? "z13-header--scrolled" : ""}`}>
      <div className="z13-header-inner">
        ...
        <nav className={`z13-nav ${menuOpen ? "z13-nav--open" : ""}`}>
          <a href="#features" className="z13-nav-link">
            Platform
          </a>
          <a href="#solutions" className="z13-nav-link">
            Solutions
          </a>
          <a href="#enterprise" className="z13-nav-link">
            Enterprise
          </a>
          <a href="#developers" className="z13-nav-link">
            Developers
          </a>
          <a href="#pricing" className="z13-nav-link">
            Pricing
          </a>
        </nav>
        ...
        <div className="z13-header-right">
          ...
          <a onClick={Handlesignup} className="z13-header-cta">
            Start for free
          </a>
          <button
  ...
  return (
    <div className="z13-page">
          ...
          <div className="z13-hero-left">
            ...
            <Reveal delay={80}>
              <h1 className="z13-headline">
                <span className="z13-typewriter">
                  {headline}
                  <span className="z13-cursor">|</span>
                </span>
            ...
            <Reveal delay={160}>
              <p className="z13-subtext">
                Zira Software is the only AI platform that puts your
                organization in total control — custom models, private data,
                full transparency.
              </p>
            </Reveal>
            ...
            <Reveal delay={220}>
              <div className="z13-hero-cta">
                <a
                  href="/signup"
                  className="z13-btn-primary z13-btn-primary--pulse"
                >
                ...
                <a className="z13-btn-ghost">Watch demo ▶</a>
              </div>
            </Reveal>
            ...
            <div className="z13-hero-right">
              <div className="z13-dashboard z13-dashboard--glow">
                <div className="z13-dashboard-header">
                  <span className="z13-dashboard-title">
                    Organization AI Health
                  </span>
                  <span className="z13-live-badge">
                    <span className="z13-live-dot" />
                    Live
                  </span>
                </div>
                  ...
                  {[
                    ...
                    <div key={label} className="z13-bar-row">
                      ...
                      <div className="z13-bar-track">
                        <div
                          className="z13-bar-fill z13-bar-fill--animate"
                          style={{ "--bar-w": `${val}%` }}
                        />
                      </div>
                    </div>
              ...
              <div className="z13-stat-cards">
                {[
                  ...
                  },
                  {
                    icon: <TrendIcon />,
                    num: "340%",
                    sub: "Avg productivity gain",
                  },
                  {
                    icon: <ClockIcon />,
                    num: "<1ms",
                    sub: "Inference latency",
                  },
      ...
      <section className="z13-marquee-section">
        <p className="z13-trusted-label">
          Trusted by teams at the world's leading organizations
        </p>
            ...
            {[...Array(2)].map((_, si) => (
              <div key={si} className="z13-marquee-set">
                {[
                  ...
                  <div key={n} className="z13-marquee-logo">
                    {n}
                  </div>
                ))}
              </div>
        ...
        <div className="z13-section-inner">
          <Reveal>
            <div className="z13-section-header">
              ...
              <h2 className="z13-section-title">
                Total AI ownership — out of the box
              </h2>
              <p className="z13-section-sub">
                Every feature is built for organizations that refuse to
                compromise on control, security, or performance.
              </p>
            </div>
          </Reveal>
            ...
            {[
              {
                ...
                desc: "Your data stays yours. Models trained on your data never cross organizational boundaries. Full data residency control included.",
                tags: [
                  "Zero data leakage",
                  "Regional hosting",
                  "GDPR compliant",
              ...
              },
              {
                ...
                desc: "See every AI decision with complete audit trails. Know exactly why your AI said what it said, every single time.",
                tags: ["Audit trails", "Decision logs", "Real-time monitoring"],
              },
              {
                icon: <BoltIcon />,
                title: "Blazing Fast",
                desc: "Sub-millisecond inference on 12 global edge locations. No cold starts. No queues. Just instant AI, everywhere.",
                tags: ["<1ms latency", "12 edge nodes", "Zero cold starts"],
              },
              {
                icon: <GridIcon />,
                title: "Modular Architecture",
                desc: "Start with one team, scale to the entire enterprise. Every module is independent and connects seamlessly.",
                tags: [
                  "Team-level deploy",
                  "Unlimited scale",
                  "No re-platforming",
              ...
              },
              {
                ...
                desc: "Real-time dashboards showing AI performance, usage, accuracy, and ROI across every team and department.",
                tags: ["Live dashboards", "ROI tracking", "Department-level"],
              },
              {
                icon: <HeadsetIcon />,
                title: "Dedicated Success Team",
                desc: "Your assigned AI success manager gets you to full deployment in under 7 days. No guessing, no documentation rabbit holes.",
                tags: ["7-day deployment", "24/7 support", "Assigned manager"],
              },
        ...
        <div className="z13-section-inner">
          <Reveal>
            <div className="z13-section-header">
              ...
              <p className="z13-section-sub">
                Every other AI platform makes you choose between power and
                control. Zira gives you both.
              </p>
            </div>
          </Reveal>
          <Reveal delay={100}>
            <div className="z13-compare-table">
              ...
              {[
                {
                  feature: "Private data — zero leakage",
                  zira: true,
                  others: false,
                  diy: true,
                },
                {
                  feature: "Full AI decision audit trails",
                  zira: true,
                  others: false,
                  diy: false,
                },
                {
                  feature: "Deploy in under 7 days",
                  zira: true,
                  others: false,
                  diy: false,
                },
                {
                  feature: "Sub-millisecond inference",
                  zira: true,
                  others: true,
                  diy: false,
                },
                ...
                {
                  feature: "Per-team AI customization",
                  zira: true,
                  others: false,
                  diy: true,
                },
                ...
                <div key={feature} className="z13-compare-row">
                  ...
                  <div className="z13-compare-col z13-compare-col--zira">
                    {zira ? (
                      <span className="z13-check-icon">✓</span>
                    ) : (
                      <span className="z13-cross-icon">✗</span>
                    )}
                  </div>
                  <div className="z13-compare-col">
                    {others ? (
                      <span className="z13-check-icon z13-check-icon--neutral">
                        ✓
                      </span>
                    ) : (
                      <span className="z13-cross-icon">✗</span>
        ...
        <div className="z13-section-inner">
          <Reveal>
            <div className="z13-section-header">
              ...
              <h2 className="z13-section-title">
                From signup to full deployment in 7 days
              </h2>
              <p className="z13-section-sub">
                Our structured onboarding gets every team running on Zira faster
                than any other enterprise AI platform.
              </p>
            </div>
          </Reveal>
            ...
            {[
              {
                ...
                desc: "Sign up and invite your team. No engineering needed. Choose your data region and privacy settings upfront.",
              },
              {
                n: "02",
                title: "Connect your data sources",
                desc: "One-click connectors for Salesforce, Slack, Google Drive, SAP, and 200+ more. Zira learns from your real data instantly.",
              },
              {
                n: "03",
                title: "Configure team AI workflows",
                desc: "Each department gets a custom AI co-pilot tailored to their exact function — sales, legal, HR, engineering, and more.",
              },
              {
                n: "04",
                title: "Measure and scale",
                desc: "Live dashboards show ROI, accuracy, and adoption across every team. Scale to new departments in one click.",
              },
            ].map((step, i) => (
            ...
            {[
              {
                initials: "JM",
                name: "James Mitchell",
                role: "Chief Digital Officer · Siemens AG",
                quote:
                  '"Zira gave us total visibility into every AI decision across 4,000 employees. The transparency alone was worth the switch. The productivity gains are extraordinary."',
              },
              {
                initials: "AL",
                name: "Aisha Laurent",
                ...
                quote:
                  "\"We spent months evaluating alternatives. Zira wasn't even a close call — it's the only platform that treats enterprise security as a first principle, not an afterthought.\"",
              },
              {
                initials: "RK",
                name: "Raj Krishnamurthy",
                role: "CTO · Bosch Global",
                quote:
                  '"Deployed across 12 departments in 9 days. The onboarding team was exceptional. Our employees went from skeptical to dependent on Zira within the first week."',
              },
        ...
        <div className="z13-section-inner">
          <Reveal>
            <div className="z13-section-header">
              ...
              <p className="z13-section-sub">
                No hidden fees. No usage traps. Just straightforward pricing for
                every stage of growth.
              </p>
              {/* Billing Toggle */}
              <div className="z13-billing-toggle">
                <span
                  className={`z13-billing-opt ${!annualBilling ? "z13-billing-opt--active" : ""}`}
                >
                  Monthly
                </span>
                <button
            ...
            {[
              ...
              (
                ...
                return (
                  <Reveal key={name} delay={i * 80}>
                    <div
                      className={`z13-plan ${featured ? "z13-plan--featured" : ""}`}
                    >
                      {badge && <div className="z13-plan-badge">{badge}</div>}
                      <div className="z13-plan-name">{name}</div>
                      <div className="z13-plan-price">
                        {price}
                        {name === "Growth" ? <span>/mo</span> : ""}
                      </div>
                      <div className="z13-plan-period">
                        {annualBilling && name === "Growth"
                          ? "billed annually"
                          : period}
                      </div>
                      {annualBilling && name === "Growth" && (
                        <div className="z13-plan-savings">
                          You save $720/year
                        </div>
                      )}
                      ...
                      <a
                        href={href}
                        className={`z13-btn-plan ${featured ? "z13-btn-plan--primary" : "z13-btn-plan--outline"}`}
                      >
                        {cta}
                      </a>
                    </div>
        ...
        <Reveal>
          <div className="z13-final-cta-inner">
            ...
            <div className="z13-final-btns">
              ...
              <a className="z13-btn-outline-lg">Schedule a demo</a>
            </div>
          </div>
        </Reveal>
      </section>
      ...
      <footer className="z13-footer">
        <div className="z13-footer-inner">
          <div className="z13-footer-brand">
            ...
            <p className="z13-footer-tagline">
              The enterprise AI platform built for total ownership.
            </p>
            <p className="z13-footer-copy">
              © 2025 Zira Software Inc. All rights reserved.
            </p>
          </div>
